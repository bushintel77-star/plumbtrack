      ...
      return (
        <div className="max-w-md mx-auto min-h-screen bg-[var(--page-bg)] flex flex-col items-center justify-center px-8 text-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-accent text-on-accent font-semibold text-sm hover:bg-accent/90 active:scale-95 transition"
          >
            <RefreshCw size={16} />
            Reload App
          </button>
