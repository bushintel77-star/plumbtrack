...
export const technicians: Technician[] = [
  { id: 't-mike', name: 'Mike Reyes', van: 'Van 2', identityColor: '#4E8CFF' },
  { id: 't-dana', name: 'Dana Whitfield', van: 'Van 1', identityColor: '#B08D57' },
  { id: 't-carlos', name: 'Carlos Mendes', van: 'Van 4', identityColor: '#C27878' },
  { id: 't-priya', name: 'Priya Nair', van: 'Van 3', identityColor: '#7A9E7E' }
]
