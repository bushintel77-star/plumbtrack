...
export function JobDetailsDialog() {
  ...
  return (
    <aside className="fixed inset-y-12 right-3 z-40 flex w-[min(360px,calc(100vw-24px))] flex-col overflow-hidden rounded-2xl border border-line/80 bg-void-95 text-ink shadow-2xl backdrop-blur-2xl motion-safe:animate-in motion-safe:fade-in-0 motion-safe:slide-in-from-right-2" aria-label="Job details" data-testid={`inspector-${job.id}`}>
